...
% Add one predication example where dimension is reduced

% Add one predication case using diamond or forked diamond
...
% TODO add the predication case made by jakoob
